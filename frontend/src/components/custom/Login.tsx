...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'oklch(0.955 0.012 240)' }}>
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border" style={{ borderColor: 'oklch(0.87 0.02 240)' }}>
          <h2 className="text-xl font-bold mb-6" style={{ fontFamily: 'Georgia, serif', color: 'oklch(0.28 0.07 240)' }}>登录账户</h2>
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'oklch(0.48 0.05 240)' }}>
            还没有账户？{' '}
            <Link to="/signup" className="font-semibold hover:underline" style={{ color: 'oklch(0.42 0.09 240)' }}>
              立即注册
            </Link>
          </p>
        </div>
